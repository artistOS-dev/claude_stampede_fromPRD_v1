  ...
  return (
    <div className="min-h-screen bg-stone-950 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        {/* Card */}
        <div className="bg-stone-900 rounded-2xl border border-stone-700 shadow-sm p-8">
          <h2 className="text-xl font-bold font-display text-stone-100 mb-6">Welcome back</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-8 text-stone-600 hover:text-stone-400 transition-colors"
