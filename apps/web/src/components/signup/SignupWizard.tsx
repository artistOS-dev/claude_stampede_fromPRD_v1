        ...
        <div className="w-full max-w-lg">
          ...
          {verificationError && step === 2 && (
            <div className="mb-4 flex items-start gap-2 p-3 rounded-lg bg-yellow-950/20 border border-yellow-700" role="alert">
              <svg className="w-4 h-4 text-yellow-400 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
          ...
          {/* Step card */}
          <div className="bg-stone-900 rounded-2xl border border-stone-700 shadow-sm p-6 sm:p-8">
            {step === 1 && (
              <Step1Credentials
                initialEmail={email}
          ...
          {step >= 3 && step <= 6 && (
            <button
              ...
              className="mt-4 w-full text-sm text-stone-600 hover:text-stone-400 transition-colors py-2 text-center"
